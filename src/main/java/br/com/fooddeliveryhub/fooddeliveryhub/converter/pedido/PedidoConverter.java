...
public class PedidoConverter {
    ...
    public static Pedido converterDtoPedido(PedidoDto pedidoDto, Usuario usuario, Restaurante restaurante, StatusPedido statusPedido,
                                            BigDecimal subtotal, BigDecimal taxaFrete){
